...
* Update the connection parameters for the database in the `oauth2.db.schema` namespace of your application.
...
Request middleware functions are located under the `oauth2.middleware` namespace.
